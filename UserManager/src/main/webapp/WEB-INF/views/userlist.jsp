        ...
        <table class="table table-hover text-center">
            <tr style="background-color: #f9f9f9;">
                <th colspan="6" style="text-align:left; padding:19px 0;padding-left:20px;">
                    ...
                    <a href="/user/useradd.do" style="float:right; padding:5px 15px; margin:0 10px;"
            ...
            <volist name="list" id="vo">
                <c:forEach items="${userlist}" var="user">
                    <tr align="center" class="foreach_tr1">
                        ...
                        <td>${user.username}</td>
                        <td style="text-align:left; padding-left: 30px;">${user.userdesc}</td>
                        ...
                        <td>
                            <div class="button-group">
                                <a class="button border-main" href="/user/userupdate.do?id=${user.id}">
                                    <span class="icon-edit"></span> 修改
                                </a>
                                <a class="button border-yellow" href="/user/userrole.do?id=${user.id}">
                                    <span class="icon-wrench"></span> 设置角色
                                </a>
                                <a class="button border-red" href="/user/deleteuser.do?id=${user.id}"
